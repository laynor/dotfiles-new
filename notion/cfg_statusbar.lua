...
mod_statusbar.create{
    ...
    -- windows and icons.
    --
    template="[ %date || load: %load ] [ CPU: %laptopstatus_cpuspeed %laptopstatus_temperature ]  UP:%netmon_kbsin DOWN: %netmon_kbsout (%netmon_avgin/%netmon_avgout)|| BATT: %laptopstatus_batterypercent %laptopstatus_batterytimeleft %laptopstatus_batterydrain %filler%systray "
